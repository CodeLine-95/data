...
?>
<div class="panel">
    <div class="panel-title box-title border-bottom-title">
        ...
        <div class="panel-body border-bottom">      
            <div class="row">
                <div class="col-lg-4 label-img-size">
                    <a href="<?=Url::to(['news/view','id'=>$list['id']])?>" class="post-label">
                        <img width="250" src="<?=($list['label_img']?\Yii::$app->params['upload_url'].$list['label_img']:\Yii::$app->params['default_label_img'])?>" alt="<?=$list['title']?>">
                    </a>
                </div>
                <div class="col-lg-8 btn-group">
                    <h1 style="font-size: 30px;"><a href="<?=Url::to(['news/view','id'=>$list['id']])?>"><?=$list['title']?></a></h1>
                    <span class="post-tags">
                        ...
                        <span class="glyphicon glyphicon-comment"></span><a href="<?=Url::to(['news/view','id'=>$list['id']])?>"><?=isset($list['extend']['comment'])?$list['extend']['comment']:0?></a>
                    </span>
                    <p class="post-content"><?=$list['summary']?></p>
                    <a href="<?=Url::to(['news/view','id'=>$list['id']])?>"><button class="btn btn-warning no-radius btn-sm pull-right">阅读全文</button></a>
                </div>
            </div>
            <div class="tags">
