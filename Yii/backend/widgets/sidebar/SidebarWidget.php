    ...
    public function init()
    {
        $this->items = [
            ...
            ['label' =>'<a href=""><i class="fa fa-th-list"></i><span>内容管理</span></a>','options'=>['class'=>'nav-parent'],'items'=>[
                    ['label'=>'文章管理','url'=>['news/index'],'items'=>[
                        ['label'=>'文章详情','url'=>['news/view'],'visible'=>false],
                        ['label'=>'更新文章','url'=>['news/update'],'visible'=>false],
                        ]                       
                    ],
                    ['label'=>'分类管理','url'=>['cats/index'],'items'=>[
                        ['label'=>'编辑分类','url'=>['cats/update'],'visible'=>false],
                        ['label'=>'分类详情','url'=>['cats/view'],'visible'=>false],
                        ]                        
                    ],
                    ['label'=>'标签管理','url'=>['tags/index'],'items'=>[
                        ['label'=>'编辑标签','url'=>['tags/update'],'visible'=>false],
