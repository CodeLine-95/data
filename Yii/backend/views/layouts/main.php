...
<section>
    ...
    <div class="leftpanel">
        <div class="leftpanelinner">
            ...
            <div class="media leftpanel-profile" data-toggle="collapse" data-target="#loguserinfo" style="cursor: pointer">
                <div class="media-left">
                    <img src="<?=Yii::$app->params['avatar']['small']?>" alt="" class="media-object img-circle">
                </div>
                <div class="media-body">
                    <h4 class="media-heading"><?=Yii::$app->user->identity->username?><a class="pull-right"><i class="fa fa-angle-down"></i></a></h4>
                    <span>管理员</span>
                </div>
